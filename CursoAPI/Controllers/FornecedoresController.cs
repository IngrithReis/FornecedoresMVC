...
namespace CursoAPI.Controllers
{
    ...
    public class FornecedoresController : ControllerBase
    {
        ...
        {
            return await _context.Fornecedores.Include("Categoria").ToListAsync();
        }
        ...
        {
            var fornecedor = await _context.Fornecedores.Include("Categoria").FirstOrDefaultAsync(x => x.Id == id);
